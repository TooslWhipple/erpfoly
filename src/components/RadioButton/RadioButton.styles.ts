...
export const RadioOptionButton = styled(Button)<{
    ...
    backgroundColor: selected ? theme.palette.background.lowBlue : backgroundColor,
    color: selected ? theme.palette.app.sidebar.textSelected : theme.palette.text.primary,
    fontWeight: selected ? 600 : 400,
    gap: "8px",
    transition: "all 0.2s ease",
    "&:hover": {
        backgroundColor: (selected) ? theme.palette.background.lowBlue : theme.palette.action.hover,
    },
}));
