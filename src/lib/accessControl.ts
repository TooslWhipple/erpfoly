...
export const DEV_MOCK_USER: User = {
  ...
  permissions: [
    ...
    "atencion_cliente.read",
    "atencion_cliente.create",
    "atencion_cliente.update",
    "atencion_cliente.reparaciones.read",
    "atencion_cliente.reparaciones.create",
    "atencion_cliente.reparaciones.update",
    "atencion_cliente.facturas.read",
    "atencion_cliente.facturas.delete",
    "orders:read",
    "orders:create",
    "branch_orders:read",
    ...
    "facturas.discrepancias.read",
    "facturas.discrepancias.create",
    "facturas.discrepancias.update",
    "routes:read",
