...
export const routeAccessRules: RouteAccessRule[] = [
  ...
  { pattern: /^\/catalogos\/vehiculos\/nuevo$/, permission: CATALOG_VEHICLES_CREATE },
  { pattern: /^\/catalogos\/vehiculos\/[^/]+$/, anyPermissions: [CATALOG_VEHICLES_READ, CATALOG_VEHICLES_UPDATE] },
  { pattern: /^\/catalogos\/vehiculos(\/.*)?$/, permission: CATALOG_VEHICLES_READ },
