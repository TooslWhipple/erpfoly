...
import { SummaryCard, ItemCard } from "@/styles/pedidos/styles";
...
export default function ResumenPedido() {
  ...
  const breadcrumbs: BreadcrumbItem[] = [
    ...
    {
      label: order?.supplier?.name || order?.branch?.name || "Nuevo pedido",
      href: "/pedidos",
    },
    {
      ...
      >
        <Stack spacing={1}>
          ...
          <Typography variant="body2" color="text.secondary" fontWeight={500}>
            Fecha de alta: {dayjs(order.created_at).format("D [de] MMMM, YYYY")}
          </Typography>
        </Stack>
        <Stack direction="row" spacing={2} alignItems="center">
          <Button
                      ...
                      <Stack direction="row" spacing={2} alignItems="center">
                        <Box
                          sx={{
                            ...
                            border: (theme) =>
                              `1px solid ${theme.palette.app.border}`,
                          }}
                        >
                          {productImage ? (
                            <Box
