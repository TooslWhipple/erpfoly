...
export default function CreditApplicationReviewPage() {
  ...
  const [activeSection, setActiveSection] =
    useState<CreditApplicationDetailSection>("basic");
  ...
  const detail = useMemo(
    () =>
      idIsValid && detailQuery.data
        ? mapCreditApplicationDetailResponseToReviewDetail(
            numericId,
            detailQuery.data,
          )
        : null,
  ...
  if (detailQuery.isError || !detail) {
    return (
      <Stack spacing={3}>
        ...
        <RevisionErrorContainer>
          <Typography>
            No se pudo cargar la solicitud, intenta nuevamente.
          </Typography>
          <Button
            variant="outlined"
        ...
        <DetailLayout>
          <SidebarColumn>
            ...
            <VerticalSidebarTabs
              ...
              value={activeSection}
              onChange={(v) =>
                setActiveSection(v as CreditApplicationDetailSection)
              }
